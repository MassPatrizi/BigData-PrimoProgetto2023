...
LOAD DATA LOCAL INPATH 'input/ReviewsCleaned.csv' INTO TABLE reviews;
--LOAD DATA LOCAL INPATH 'input/duplicated_output.csv' INTO TABLE reviews;
--LOAD DATA LOCAL INPATH 'input/quintupled_output.csv' INTO TABLE reviews;
--LOAD DATA LOCAL INPATH 'input/decupled_output.csv' INTO TABLE reviews;
